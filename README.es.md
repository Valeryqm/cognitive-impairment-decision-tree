...
Proyecto de aprendizaje supervisado que clasifica a 150 pacientes en tres grupos clínicos — **sanos**, **deterioro cognitivo leve (GDS 3)** y **deterioro cognitivo moderado (GDS 4)** — a partir de ocho indicadores neuropsicológicos binarios. El objetivo es un modelo preciso **y** legible: un conjunto corto de reglas que un profesional pueda seguir.
...
**El árbol usa solo tres preguntas:**
